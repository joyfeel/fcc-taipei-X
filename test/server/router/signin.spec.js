...
describe.only('/signin', () => {
  ...
  it('abnormal signin [wrong format email]', done => {
    request()
      .post('/v1/signin')
      .send({
        ...validUser,
  ...
  it('abnormal signin [wrong format password]', done => {
    request()
      .post('/v1/signin')
      .send({
        ...validUser,
  ...
  it('abnormal signin [account exist, wrong password]', done => {
    request()
      .post('/v1/signin')
      .send({
        ...validUser,
