...
describe('POST /signup', () => {
  ...
  it('normal signup', function(done) {
    this.timeout(20000)    // 20 秒後 SMTP server 沒反應則 fail
    request()
      .post('/v1/signup')
      .send(userSignupInfo)
      .expect('Content-Type', 'application/json; charset=utf-8')
  ...
  it('abnormal active [not token]', (done) => {
    request()
      .get('/v1/signup')
  ...
  it.only('active account', (done) => {
    ...
    request()
      ...
      .expect(200)          //Shold be change to 422 in the futher
      .expect(valid)
      .end(done)
  })
...
function valid(res) {
  //console.log(res.body.user.nickname.sho)
  //res.body.should.have.property('token', 'Joey')
  res.body.user.nickname.should.be.equal('Joey')
}

/*
describe('Get /signup', () => {
  it('expect is hello world', function (done) {
    this.timeout(10000)   //如果寄一封信超過10秒，那乾脆別寄惹，ㄏㄏ
    ...
    request()
      ...
      .send({
        ...
        email: 'joybee210@gmail.com',
        password: 'aaaaaa',
        photo: 'data:image/jpeg;base64,'
      })
      .expect(200)
      .expect({
        status: 'success'
